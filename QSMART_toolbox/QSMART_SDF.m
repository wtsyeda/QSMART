...
if stage==1
    ...
    lfs_sdf_1=sdf(tfs,mask.*R_0,indent,ones(imsize(1:3)),params.s1.sdf_sigma1,params.s1.sdf_sigma1,params.iminfo.resolution);
...
elseif stage==2
    ...
    lfs_sdf_2=sdf(tfs.*mask.*R_0,mask.*R_0,indent,vasc_only,params.s2.sdf_sigma1,params.s2.sdf_sigma2,params.iminfo.resolution);
